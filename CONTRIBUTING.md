# Contributing to Danger Framework

If you're reading this, you're definitely awesome! <br /> The following is a set
of guidelines for contributing to Danger Framework, which are hosted in the
[GitHub](https://github.com/Tap30/danger). These are mostly guidelines, not
...
[Code of Conduct](https://github.com/Tap30/danger/blob/main/CODE_OF_CONDUCT.md).
...
[good first issues](https://github.com/Tap30/danger/issues?q=is:open+is:issue+label:"good+first+issue")
...
[good to take issues](https://github.com/Tap30/danger/issues?q=is:open+is:issue+label:"good+to+take").
...
```sh
git clone https://github.com/<your username>/danger.git
cd danger
git remote add upstream https://github.com/Tap30/danger.git
```
...
7. Go to [the repository](https://github.com/Tap30/danger) and make a Pull
   Request.
